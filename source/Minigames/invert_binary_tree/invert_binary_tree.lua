...
local playdate_image_table = gfx.imagetable.new("Minigames/invert_binary_tree/images/playdate")
local low_battery_image_table = gfx.imagetable.new("Minigames/invert_binary_tree/images/playdate_low_battery")
